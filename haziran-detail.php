...
$sql = "SELECT ad, soyad, ukd FROM haziran";
...
<main>
        ...
        <h2>Haziran Ayı Satranç Turnuvası Kayıt Formu</h2>
        </div>
        <section id="reg">
        ...
        <br><br>
        <strong>Tarih: 22-30 Haziran</strong>
        <br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO haziran (ad, soyad, ukd)
            VALUES ('$ad', '$soyad', '$ukd')";
