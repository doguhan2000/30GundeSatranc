...
<header>
    ...
    <section class="content">
        <div class="content-wrapper">
            <img src="mayis.png" class="content-image" alt="İçerik Resmi">
            <div class="content-text">
                <h2>Mayıs Ayı Satranç UKD Turnuvası</h2>
                <p>
        ...
        <a href="mayis-detail.php" >Kayıt ol </a> üzerinden online formu doldurabilirsiniz.
        <br><br>
