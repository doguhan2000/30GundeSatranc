    ...
    <section class="content">
        <div class="content-wrapper">
            ...
            <div class="content-text">
                <h2>Ekim Ayı Satranç Turnuvası</h2>
                <p>
        <h3>DEÜ Satranç Kulübü katkılarıyla satranç turnuvası düzenlenecektir.</h3>
        <br><br>
        Değerli Satranç Severler,
        <br><br>
        DEÜ Satranç Kulübü olarak heyecan verici bir etkinliğe daha ev sahipliği yapıyoruz! <strong>22-30 Ekim </strong>tarihleri arasında düzenleyeceğimiz satranç turnuvasına katılmak için hazır mısınız?
        <br><br>
        <strong>Turnuva Detayları:</strong>
        <br><br>
        <strong>Tarih: 22-30 Ekim </strong>
        <br>
        ...
        <a href="ekim-detail.php" >Kayıt ol </a> üzerinden online formu doldurabilirsiniz.
        <br><br>
