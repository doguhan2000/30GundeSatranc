...
<header>
    ...
    <section class="content">
        <div class="content-wrapper">
            <img src="eylul.png" class="content-image" alt="İçerik Resmi">
            <div class="content-text">
                <h2>Eylül Ayı Satranç Turnuvası</h2>
                <p>
        <h3>DEÜ Satranç Kulübü katkılarıyla satranç turnuvası düzenlenecektir.</h3>
        <br><br>
        Değerli Satranç Severler,
        <br><br>
        DEÜ Satranç Kulübü olarak heyecan verici bir etkinliğe daha ev sahipliği yapıyoruz! <strong>22-30 Eylül </strong>tarihleri arasında düzenleyeceğimiz satranç turnuvasına katılmak için hazır mısınız?
        <br><br>
        <strong>Turnuva Detayları:</strong>
        <br><br>
        <strong>Tarih: 22-30 Eylül </strong>
        <br>
        ...
        <a href="eylul-detail.php" >Kayıt ol </a> üzerinden online formu doldurabilirsiniz.
        <br><br>
